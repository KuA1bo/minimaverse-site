...
// Compact hybrid version: clean layout + visual enhancements + verified info
        ...
        <ul className="space-y-2 text-sm">
          ...
          <li>
            ...
            <ExternalLink 
              ...
              className="text-blue-400 hover:text-blue-300 underline ml-1"
            >
              minima.global/technology/overview
            </ExternalLink>
          </li>
          <li>
      ...
      <article className="prose prose-invert max-w-none animate-fade-in">
        ...
        <section className="mb-10 opacity-0 animate-fade-in-up delay-200">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-gray-800/50 border border-gray-700 rounded-lg p-4 
                            transition-all duration-200 hover:border-blue-500/50 hover:shadow-lg hover:shadow-blue-500/5">
              <h3 className="text-white font-medium mb-2">Compact State (~5-10 MB)</h3>
            ...
            <table className="w-full border border-gray-700 rounded-lg">
              <thead className="bg-gray-800">
                <tr>
                  ...
                  <th className="text-left p-3 text-gray-300 font-semibold">Traditional</th>
                  <th className="text-left p-3 text-gray-300 font-semibold">Minima</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-700">
                <tr className="hover:bg-gray-800/30 transition-colors">
                  ...
                  <td className="p-3 text-green-400 font-medium">~5-10 MB, mobile/IoT</td>
                </tr>
                <tr className="hover:bg-gray-800/30 transition-colors">
