...
// Structured data for Schema.org CollectionPage
const structuredData = {
  "@context": "https://schema.org",
  "@type": "CollectionPage",
  "name": "Minima Ecosystem Partnerships (Verified List)",
  "description": "Publicly verified collaborations and integrations in the Minima ecosystem, with sources and dates.",
  "url": "https://minimaverse.com/partners",
  "isPartOf": {
    "@type": "WebSite",
    "name": "Minimaverse",
        ...
        <section id="verified" className="mb-10 opacity-0 animate-fade-in-up delay-150 scroll-mt-20">
          ...
          <div className="space-y-4">
            {[
              ...
              { date: 'June 12, 2024', title: 'McLaren GT4', text: 'Partnership with Influx Technology to integrate on-chain race data logging for McLaren GT4 at Spa-Francorchamps.', source: 'https://minima.global/post/minima-l1-blockchain-powers-the-worlds-first-on-chain-race-data-logger-for-mclaren-gt4-supercar-at-spa' },
              { date: 'April 30, 2024', title: 'OPP (Online Payment Platform)', text: 'Partnership related to tokenized access for private EV charging infrastructure.', source: 'https://minima.global/post/minima-partners-with-opp-online-payment-platform-to-commodify-private-charging-points-worldwide-in-7-3b-ev-market' },
