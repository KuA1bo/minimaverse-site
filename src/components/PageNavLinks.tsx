// src/components/PageNavLinks.tsx
// Semantic topic graph navigation component for internal linking
// Renders 3 contextual links based on current page for SEO and UX
...
interface PageNavLinksProps {
  links: [NavLink, NavLink, NavLink]; // Exactly 3 links as per spec
}
