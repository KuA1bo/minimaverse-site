  ...
  return (
    <>
      ...
      <header className="relative sm:sticky sm:top-0 z-50 mb-8 sm:mb-12 backdrop-blur-xl bg-black/30 border-b border-gray-700/40 transition-all duration-300 hover:border-purple-500/40">
        ...
        <div className="flex items-center justify-between gap-3 sm:gap-4 max-w-6xl mx-auto px-3 sm:px-4 py-0.5 sm:py-1.5">
          <Link
            href="/"
          ...
          >
            <Image
              ...
              width={88}
              height={88}
              className="w-11 h-11 sm:w-[52px] sm:h-[52px] object-contain bg-transparent mix-blend-screen"
              priority
              unoptimized
            />
